    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">{{ __('common.report.checkout') }}</li>
            </ol>
        </nav>
    </div>
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between">
                <h5 class="page-title mt-3 mb-3">{{ __('common.report.checkout') }}</h5>
            ...
            <div class="" style="display: none;" id="filterFormContain" name="filterFormContain">
                <form action="" method="GET" {{ request()->all() ? 'block' : 'none' }} id="filterForm" name="filterForm">
                    <div class="row mb-3">
                        ...
                        <div class="col-3">
                            <label for="" class="font-medium font-14" >{{ __('attributes.checkout.ref') }}</label>
                            <input type="text" name="reference" id="reference" class="form form-control font-14 mt-1 mb-2" value="{{ old('reference', request('reference')) }}" placeholder="{{ __('attributes.checkout.ref') }}">
                        </div>
                        <div class="col-3 mt-1">
                            <label for="" class="font-medium font-14" >{{ __('attributes.checkout.contact') }}</label>
                        ...
                        <div class="col-3 mt-1">
                            <label for="" class="font-medium font-14" >{{ __('attributes.checkout.warehouse') }}</label>
                            <select name="warehouse_id" id="warehouse" class="choices w-full mt-1 mb-2">
                                <option value="" disabled selected hidden>{{ __('attributes.checkout.warehouse') }}</option>
        ...
        <div class="card-body">
            <div class="mt-1">
                <div>
                    @include('pages.report.table.table_list_checkout', ['checkouts' => $checkouts])
                </div>
            </div>
        </div>
    </div>
    ...
    @push('js')
        <script type="module">
            ...
            $('#resetFilter').on('click', function() {
                const baseUrl = "{{ route('reports.checkout') }}" + '?searchFilter';

    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">{{ __('common.report.adjustments') }}</li>
            </ol>
        </nav>
    </div>
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between">
                <h5 class="page-title mt-3 mb-3">{{ __('common.report.adjustments') }}</h5>
            ...
            <div class="" style="display: none;" id="filterFormContain" name="filterFormContain">
                <form action="" method="GET" {{ request()->all() ? 'block' : 'none' }} id="filterForm" name="filterForm">
                    <div class="row mb-3">
                        ...
                        <div class="col-3">
                            <label for="" class="font-medium font-14" >{{ __('attributes.adjustment.ref') }}</label>
                            <input type="text" name="reference" id="reference" class="form form-control font-14 mt-1 mb-2" value="{{ old('reference', request('reference')) }}" placeholder="{{ __('attributes.adjustment.ref') }}">
                        </div>
                        <div class="col-3 mt-1">
                            <label for="" class="font-medium font-14" >{{ __('attributes.adjustment.warehouse') }}</label>
        ...
        <div class="card-body">
            <div class="mt-1">
                <div>
                    @include('pages.report.table.table_list_adjustment', ['adjustments' => $adjustments])
                </div>
            </div>
        </div>
    </div>
    ...
    @push('js')
        <script type="module">
            ...
            $('#resetFilter').on('click', function() {
                const baseUrl = "{{ route('reports.adjustment') }}" + '?searchFilter';

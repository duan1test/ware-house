<tbody class="border-top" id="item-{{ $itemId }}">
    <tr>
        ...
        <td class="border-bottom-0 pb-0 fw-bold">
            ...
            <input type="number" name="items[{{ $itemId }}][weight]" class="form-control" value="1" hidden>
            <input type="number" name="items[{{ $itemId }}][track_weight]" class="form-control" value="{{ $trackWeight }}" hidden>
        </td>
    </tr>
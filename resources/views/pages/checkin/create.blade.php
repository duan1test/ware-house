<x-app-layout>
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">{{ __('common.checkin.create') }}</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="page-title mt-3 mb-3">{{ __('common.checkin.create') }}</h5>
        </div>
        <form method="POST" id="form-create" action="{{ route('checkins.store') }}" style="display: contents;" enctype="multipart/form-data">
            <div class="card-body">
                <div class="row">           
                    @csrf
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="input-container">
                            ...
                            <input type="text" onkeyup="checkValue('error-reference')" value="{{ old('reference') }}" id="error-reference" class="form-control" placeholder="{{ __('attributes.checkin.ref') }}" name="reference">

...
class Unit extends Model
{
    ...
    protected $fillable = [
        'name', 'code', 'base_unit_id', 'operator', 'operation_value',
    ];
    ...
    public function scopeFilter($query, array $filters)
    {
        ...
        $query->when($filters['status'] == 'with_trashed', function ($query) {
            $query->withTrashed();
        })->when($filters['status'] == 'only_trashed', function ($query) {
            $query->onlyTrashed();
        });
    }
    ...
    public function scopeFilters($query, array $filters)
    {
        ...
        $query->when($filters['base_unit'] ?? null, fn ($q, $base) => $q->childrenOf($base));
